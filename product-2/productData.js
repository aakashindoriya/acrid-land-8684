...
let bestSellerData = [
  ...
  bestSellerData.forEach((el) => {
    ...
    div_1.setAttribute("class","product-card");
    div_1.setAttribute("id","container-2");

    // img div   append --> div_1
    let img_div = document.createElement("div");
    img_div.setAttribute("class","product-image");
    
    let span = document.createElement("span");
    span.setAttribute("class","discount-tag");
    span.innerText = el.offer;
    ...
    // product into
    let pro_info = document.createElement("div");
    pro_info.setAttribute = ("class","product-info")
    ...
    h3.setAttribute = ("class","product-brand")
    h3.innerText = el.title;

    let span_1 = document.createElement("span");
    span_1.setAttribute = ("class","price");
    span_1.innerText = el.price;

    
// appending to image div
// 1st div
    img_div.append(span,img)
// 2nd div
    pro_info.append(p,h3,span_1)
// 3rd div -->con-2
    div_1.append(img_div,pro_info)
  // 4th div -->last
